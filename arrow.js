...
//diamond notch vectors
const frontRidge = new THREE.Vector3(-0.1, -0.2, 0.35);
const backRidge = new THREE.Vector3(-0.1, -0.2, -0.35);
const notchValley = new THREE.Vector3(0, -0.18, 0);
...
function addFacet(a, b, c) {
  //calculates a vector perpendicular to the triangle’s surface
...
mesh.update = (delta) => {
  const rotationOffset = THREE.MathUtils.euclideanModulo(mesh.rotation.y - initialRotationY + Math.PI, Math.PI * 2) - Math.PI;
